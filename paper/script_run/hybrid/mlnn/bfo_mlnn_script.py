...
from model.main.hybrid_mlnn import BfoMlnn
from utils.IOUtil import read_dataset_file
from utils.SettingPaper import bfo_mlnn_paras_final as param_grid
...
if test_type == "normal":           ### For normal test
    ...
    all_model_file_name = "stability_bfo_mlnn"
else:
    pass
...
def train_model(item):
    ...
    bfo_paras = {
        ...
        "Ned": item["Ned"], "Nre": item["Nre"], "Nc": item["Nc"],
        "attract_repel": item["attract_repel"]
    }
    md = BfoMlnn(root_base_paras=root_base_paras, root_hybrid_paras=root_hybrid_paras, bfo_paras=bfo_paras)
    md._running__()
