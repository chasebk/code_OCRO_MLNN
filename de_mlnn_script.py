...
from model.main.hybrid_mlnn import DeMlnn
from utils.IOUtil import read_dataset_file
from utils.SettingPaper import de_mlnn_paras_final as param_grid
...
if test_type == "normal":  ### For normal test
    ...
    all_model_file_name = "stability_de_mlnn"
else:
    pass
...
def train_model(item):
    ...
    md = DeMlnn(root_base_paras=root_base_paras, root_hybrid_paras=root_hybrid_paras, de_paras=de_paras)
    md._running__()
