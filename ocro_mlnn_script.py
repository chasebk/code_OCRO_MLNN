...
if test_type == "normal":  ### For normal test
    ...
    all_model_file_name = "stability_ocro_mlnn"
else:
    pass
...
def train_model(item):
    ...
    ocro_paras = {"restart_count": item["restart_count"]}

    md = OCroMlnn(root_base_paras=root_base_paras, root_hybrid_paras=root_hybrid_paras, cro_paras=cro_paras, ocro_paras=ocro_paras)
    md._running__()
